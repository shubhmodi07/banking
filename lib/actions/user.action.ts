...
export const signUp = async ({ password, ...userData }: SignUpParams) => {
  ...
  try {
    ...
    console.log('New Appwrite user account created:', newUserAccount);
    ...
    // Save the user and Dwolla info in the database
    ...
    console.log('Session created and cookie set for user:', newUserAccount.$id);
    ...
    if (error instanceof Error) {
      ...
      throw new Error(error.message || 'Sign-up process failed');
    } else {
      console.error('Unknown error during sign-up:', error);
      throw new Error('Sign-up process failed due to an unknown error');
    }
  }
};
...
export async function getLoggedInUser() {
  ...
  export const logoutAccount = async () => {
    try {
        ...
        // Set the cookie with an empty value and a past expiration date
